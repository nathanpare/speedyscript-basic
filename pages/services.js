    ...
    <div className='text-white h-screen snap-y snap-mandatory overflow-scroll'>
      ...
      <section id='service-2' className='snap-center h-screen flex flex-col 
       items-center pt-8'>
        ...
        <p id='bottom-2' className='text-xl sm:text-2xl text-center px-5'>We offer state of the art
      ...
      <section id='service-3' className='snap-center h-screen flex flex-col 
       items-center pt-5'>
        ...
        <p id='bottom-3' className='text-xl sm:text-2xl text-center px-5'>We offer Internet Marketing
      ...
      <section id='service-4' className='snap-center h-screen flex flex-col 
       items-center pt-5'>
        <div id='top-4' className='text-2xl sm:text-3xl md:text-4xl flex flex-row items-center py-24'>
          <motion.div
            className='px-5 mx-auto mr-24'
            id='left-4'
            initial={{
        ...
        <p id='bottom-4' className='text-xl sm:text-2xl text-center overflow-y-auto px-5'>We offer Data Analysis services so you can find out what you should be spending your valuable time on!</p>
